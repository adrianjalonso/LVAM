...
export default function App () {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/Favoritos" element={<Favoritos carrinho={carrinho} setCarrinho={setCarrinho} favoritos={favoritos} setFavoritos={setFavoritos}  totalMasculino={totalMasculino} setTotalMasculino={setTotalMasculino} total={total} setTotal={setTotal} totalFeminino={totalFeminino} setTotalFeminino={setTotalFeminino} totalKids={totalKids} setTotalKids={setTotalKids} />} />
